...
subplot(1, 2, 2);
imagesc(reshape(Images(Partition,:), [400, 300]));
title({['Individu le plus proche (bayesien) : posture ' num2str(posture_proche) ' de ', liste_personnes{personne_proche}]}, 'FontSize', 20);
axis image;
